...
return array(
	...
	'content'    => '
		...
		<div class="wp-block-group alignfull has-edelherzig-bg-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--40)"><!-- wp:columns {"align":"wide"} -->
		...
		<p class="has-text-align-left has-normal-font-size">' . esc_html( $edelherzig_strings['testimonial'] ) . '</p>
		<!-- /wp:paragraph -->

		<!-- wp:paragraph {"align":"left","style":{"elements":{"link":{"color":{"text":"var:preset|color|edelherzig-accent"}}}},"textColor":"edelherzig-accent","fontSize":"normal"} -->
		<p class="has-text-align-left has-edelherzig-accent-color has-text-color has-link-color has-normal-font-size">★ ★ ★ ★ ★</p>
		<!-- /wp:paragraph -->
		...
		<p class="has-text-align-left has-small-font-size" style="font-style:normal;font-weight:600;letter-spacing:2px;text-transform:uppercase">' . esc_html( $edelherzig_strings['testimonial_name'] ) . '</p>
		<!-- /wp:paragraph --></div>
		<!-- /wp:column -->
