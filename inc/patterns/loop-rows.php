...
return array(
	'title'      => __( 'Posts Loop Rows', 'edelherzig-base' ),
			...
			<div class="wp-block-query alignwide">
				...
				<div class="wp-block-columns" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
					...
					<div class="wp-block-column is-vertically-aligned-center" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50);flex-basis:50%">
						...
						<!-- wp:read-more {"content":"' . esc_html( $edelherzig_strings['continue_reading'] ) . '","style":{"elements":{"link":{"color":{"text":"var:preset|color|edelherzig-accent"}}}},"textColor":"edelherzig-accent"} /-->
					</div>
					<!-- /wp:column -->
				</div>
				<!-- /wp:columns -->
				...
				<p class="has-text-align-center has-edelherzig-bg-alt-background-color has-background">Unfortunately no posts were found</p>
				<!-- /wp:paragraph -->
				<!-- /wp:query-no-results -->
			</div>
			<!-- /wp:query -->
