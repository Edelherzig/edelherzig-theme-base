...
return array(
	...
	'content'    => '
		...
		<h1 class="wp-block-heading has-text-align-left">' . esc_html( $edelherzig_strings['hero_title'] ) . '</h1>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"align":"left"} -->
		<p class="has-text-align-left">' . esc_html( $edelherzig_strings['feature_description'] ) . '</p>
		<!-- /wp:paragraph -->
