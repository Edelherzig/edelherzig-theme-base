...
return array(
	'title'      => __( 'Call to Action 2', 'edelherzig-base' ),
	...
	'content'    => '
		...
		<h2 class="wp-block-heading">' . esc_html( $edelherzig_strings['cta_title'] ) . '</h2>
		<!-- /wp:heading --></div>
		<!-- /wp:column -->
		<!-- wp:column {"width":"50%"} -->
		...
		<div class="wp-block-button is-style-primary is-style-fill"><a class="wp-block-button__link wp-element-button">' . esc_html( $edelherzig_strings['button_text'] ) . '</a></div>
		<!-- /wp:button --></div>
		<!-- /wp:buttons --></div>
		<!-- /wp:column --></div>
		<!-- /wp:columns --></div>
