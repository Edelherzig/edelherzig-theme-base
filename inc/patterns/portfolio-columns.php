<?php
/**
 * Portfolio Columns Pattern for Edelherzig Theme
 *
 * @author Themeisle
 * @package edelherzig
 * @since 1.0.5
...
return array(
	'title'      => __( 'Portfolio Columns', 'edelherzig-base' ),
		...
		<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--40)">
			...
			<div class="wp-block-columns alignwide">
				...
				<div class="wp-block-column">
					...
					<h2 class="wp-block-heading has-text-align-center">' . esc_html( $edelherzig_strings['portfolio_title'] ) . '</h2>
					<!-- /wp:heading -->
					...
					<h3 class="wp-block-heading has-text-align-center has-small-font-size" style="font-style:normal;font-weight:600;text-transform:uppercase">' . esc_html( $edelherzig_strings['portfolio_client'] ) . '</h3>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:column -->
