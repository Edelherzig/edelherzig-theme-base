...
return array(
	'title'      => __( 'Text Columns', 'edelherzig-base' ),
	...
	'content'    => '
		...
		<!-- wp:heading -->
		<h2 class="wp-block-heading">' . esc_html( $edelherzig_strings['content_title'] ) . '</h2>
		<!-- /wp:heading -->
		...
		<p class="has-large-font-size">' . esc_html( $edelherzig_strings['feature_description'] ) . '</p>
		<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<h3 class="wp-block-heading has-small-font-size" style="font-style:normal;font-weight:600;text-transform:uppercase">' . esc_html( $edelherzig_strings['content_subtitle'] ) . '</h3>
		<!-- /wp:heading -->
