...
return array(
	'title'      => __( 'Pricing Plans 5', 'edelherzig-base' ),
				...
				<div class="wp-block-columns">
					...
					<div class="wp-block-column is-vertically-aligned-center">
						...
						<div class="wp-block-group" style="border-radius:5px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
							...
							<h2 class="wp-block-heading has-text-align-left">' . esc_html( $edelherzig_strings['pricing_section_title'] ) . '</h2>
							<!-- /wp:heading -->

							<!-- wp:paragraph {"align":"left"} -->
							<p class="has-text-align-left">' . esc_html( $edelherzig_strings['paragraph_text'] ) . '</p>
							<!-- /wp:paragraph -->
						</div>
						<!-- /wp:group -->
					</div>
					...
					<!-- wp:column {"backgroundColor":"edelherzig-bg-alt"} -->
					<div class="wp-block-column has-edelherzig-bg-alt-background-color has-background">
						...
						<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
							...
							<div class="wp-block-group">
								...
								<p class="has-text-align-left" style="font-size:3rem">' . esc_html( $edelherzig_strings['price'] ) . '</p>
								<!-- /wp:paragraph -->
							...
							<p class="has-text-align-left has-normal-font-size">' . esc_html( $edelherzig_strings['price_feature'] ) . '</p>
							<!-- /wp:paragraph -->
							...
							<div class="wp-block-buttons">
								<!-- wp:button {"textColor":"edelherzig-fg-alt","width":100,"className":"is-style-fill"} -->
