...
return array(
	...
	'content'    => '
		...
		<h2 class="wp-block-heading has-text-align-center has-huge-font-size">' . esc_html( $edelherzig_strings['cta_title'] ) . '</h2>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"align":"center","fontSize":"medium"} -->
		<p class="has-text-align-center has-medium-font-size">' . esc_html( $edelherzig_strings['short_text'] ) . '</p>
		<!-- /wp:paragraph --></div>
		<!-- /wp:group -->

		<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
		<div class="wp-block-buttons"><!-- wp:button {"className":"is-style-outline"} -->
		<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button">' . esc_html( $edelherzig_strings['button_text'] ) . '</a></div>
		<!-- /wp:button -->
