<?php
/**
 * Pricing Plans 3 Pattern for Edelherzig Theme
 *
 * @author Themeisle
 * @package edelherzig
 * @since 1.0.5
...
return array(
	'title'      => __( 'Pricing Plans 3', 'edelherzig-base' ),
