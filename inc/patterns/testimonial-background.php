		...
		<div class="wp-block-group alignfull has-edelherzig-fg-alt-color has-edelherzig-accent-background-color has-text-color has-background has-link-color" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--40)">
			...
			<div class="wp-block-group alignwide">
				...
				<div class="wp-block-group">
					...
					<!-- wp:paragraph {"align":"left","fontSize":"medium"} -->
					<p class="has-text-align-left has-medium-font-size">' . esc_html( $edelherzig_strings['testimonial'] ) . '</p>
					<!-- /wp:paragraph -->
