<?php
/**
 * Pricing Plans 2 Pattern for Edelherzig Theme
 *
 * @author Themeisle
 * @package edelherzig
 * @since 1.0.5
...
return array(
	'title'      => __( 'Pricing Plans 2', 'edelherzig-base' ),
			...
			<div class="wp-block-group alignwide">
				...
				<div class="wp-block-columns">
					...
					<div class="wp-block-column" style="flex-basis:25%">
						...
						<h2 class="wp-block-heading is-style-default">' . esc_html( $edelherzig_strings['pricing_section_title'] ) . '</h2>
						<!-- /wp:heading -->

						<!-- wp:paragraph {"fontSize":"normal"} -->
						<p class="has-normal-font-size">' . esc_html( $edelherzig_strings['section_description'] ) . '</p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:column -->

					<!-- wp:column {"style":{"spacing":{"padding":{"top":"var:preset|spacing|40","right":"var:preset|spacing|40","bottom":"var:preset|spacing|40","left":"var:preset|spacing|40"},"blockGap":"16px"}},"backgroundColor":"edelherzig-bg-alt"} -->
