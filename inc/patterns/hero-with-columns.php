<?php
/**
 * Hero with Columns Pattern for Edelherzig Theme
 *
 * @author Themeisle
 * @package edelherzig
 * @since 1.0.5
	...
	'content'    => '
		...
		<div class="wp-block-group alignfull" style="margin-top:0px;margin-bottom:0px;padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--40)">
			...
			<div class="wp-block-group alignwide">
				...
				<h1 class="wp-block-heading has-text-align-center has-xxl-font-size">' . esc_html( $edelherzig_strings['hero_title'] ) . '</h1>
				<!-- /wp:heading -->

				<!-- wp:paragraph {"align":"center","fontSize":"medium"} -->
				<p class="has-text-align-center has-medium-font-size">' . esc_html( $edelherzig_strings['section_description'] ) . '</p>
				<!-- /wp:paragraph -->
				...
				<div class="wp-block-columns">
					<!-- wp:column {"verticalAlignment":"top","style":{"spacing":{"padding":{"top":"var:preset|spacing|40","right":"var:preset|spacing|40","bottom":"var:preset|spacing|40","left":"var:preset|spacing|40"}}},"backgroundColor":"edelherzig-bg-alt"} -->
					<div class="wp-block-column is-vertically-aligned-top has-edelherzig-bg-alt-background-color has-background" style="padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)">
						...
						<h2 class="wp-block-heading has-medium-font-size">' . esc_html( $edelherzig_strings['content_subtitle'] ) . '</h2>
						<!-- /wp:heading -->
						...
						<div class="wp-block-buttons">
							...
							<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button" style="padding-top:8px;padding-right:16px;padding-bottom:8px;padding-left:16px">' . esc_html( $edelherzig_strings['button_text'] ) . '</a></div>
							<!-- /wp:button -->
						</div>
						<!-- /wp:buttons -->
					</div>
