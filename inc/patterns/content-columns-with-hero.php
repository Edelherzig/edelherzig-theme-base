<?php
/**
 * Content Columns with Hero Pattern for Edelherzig Theme
 *
 * @author Themeisle
 * @package edelherzig
 * @since 1.0.5
...
return array(
	'title'      => __( 'Content Columns with Hero', 'edelherzig-base' ),
	'categories' => array( 'edelherzig/content' ),
	'content'    => '
		<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"var:preset|spacing|40","right":"var:preset|spacing|40"},"margin":{"top":"0","bottom":"0"},"blockGap":"var:preset|spacing|50"}},"backgroundColor":"edelherzig-bg-alt","layout":{"inherit":true,"type":"constrained"}} -->
		<div class="wp-block-group alignfull has-edelherzig-bg-alt-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--40)">
			...
			<div class="wp-block-group">
				...
				<h2 class="wp-block-heading has-text-align-center has-huge-font-size">' . esc_html( $edelherzig_strings['section_title'] ) . '</h2>
				<!-- /wp:heading -->

				<!-- wp:paragraph {"align":"center","fontSize":"large"} -->
				<p class="has-text-align-center has-large-font-size">' . esc_html( $edelherzig_strings['section_description'] ) . '</p>
				<!-- /wp:paragraph -->
			...
			<div class="wp-block-group alignwide">
				...
				<div class="wp-block-columns">
					...
					<div class="wp-block-column is-vertically-aligned-center">
						<!-- wp:heading {"level":3} -->
						<h3 class="wp-block-heading">' . esc_html( $edelherzig_strings['feature_title'] ) . '</h3>
						<!-- /wp:heading -->
